package com.example.xiaomingassistant.ui.view.RealtimeBlurView;
...
public class RealtimeBlurView extends View {
	...
	protected BlurImpl getBlurImpl() {
		// 直接返回 Android 原生 RenderScript 实现，不再进行复杂的检测
		try {
			...
			// 如果 RenderScript 挂了，返回一个什么都不做的空实现
			return new BlurImpl() {
				@Override public boolean prepare(Context context, Bitmap buffer, float radius) { return false; }
				@Override public void release() {}
				@Override public void blur(Bitmap input, Bitmap output) {}
			};
		}
	}
